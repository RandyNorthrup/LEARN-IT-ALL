...
const StepDesignEvidenceKindSchema = z.enum([
  ...
  'css-source-computed-persistence',
  'css-html-presentation-boundary',
  'css-rule-anatomy',
  'stylesheet-load-evidence',
  'selector-match-set',
  'selector-relationship-match-set',
  'attribute-operator-match-set',
  'pseudo-class-state-transition',
  'pseudo-element-fragment',
  'list-marker-counter-sequence',
  'css-value-provenance',
  'cascade-winner-trace',
  'specificity-column-trace',
  'layer-scope-order-trace',
  'link-state-accessibility-matrix',
  'custom-property-provenance',
  'var-substitution-trace',
  'custom-property-dependency-graph',
  'registered-property-contract',
  'typed-interpolation-trace',
  'display-box-tree-trace',
  'inline-whitespace-fragment-trace',
  'box-area-measurement',
  'box-sizing-equation',
  'margin-collapse-group',
  'formatting-context-boundary',
  'intrinsic-size-contribution',
  'length-reference-frame',
  'percentage-basis-trace',
  'css-math-type-trace',
  'bounded-value-constraint',
  'logical-axis-mapping',
  'normal-flow-size-trace',
  'overflow-access-path',
...
const StepDesignLayoutSchema = z.enum([
  ...
  'name-description-inspector',
  'inclusion-focus-inspector',
  'reading-focus-order-trace',
  ...
  'css-source-computed-inspector',
  'html-css-boundary-board',
  'css-rule-parser',
  'stylesheet-network-inspector',
  'selector-match-visualizer',
  'selector-relationship-visualizer',
  'attribute-operator-table',
  'state-transition-inspector',
  'pseudo-element-render-tree',
  'list-marker-counter-inspector',
  'css-value-provenance-inspector',
  'cascade-precedence-ladder',
  'specificity-column-comparator',
  'layer-scope-order-map',
  'link-state-behavior-matrix',
  'custom-property-substitution-inspector',
  'custom-property-dependency-map',
  'registered-property-contract-board',
  'typed-interpolation-timeline',
  'display-box-tree-inspector',
  'inline-formatting-line-map',
  'box-area-measurement-board',
  'box-sizing-equation-board',
  'margin-collapse-graph',
  'formatting-context-inspector',
