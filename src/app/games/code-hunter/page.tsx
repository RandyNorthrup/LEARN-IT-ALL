...
export default function CodeHunterGame() {
  ...
  const codeLines = challenge.code.split('\n').map((line, index) => ({
    id: `challenge-${currentChallenge}-line-${index + 1}`,
    line,
    lineNumber: index + 1,
  }));
            ...
            return (
              <div className="rounded-2xl bg-white p-8 shadow-xl text-center">
                ...
                <p className="text-gray-600 mb-6 text-lg">
                  Find bugs in Python code as fast as you can. Each correct answer gives you 10
                  points. Using hints reduces points to 5. You have 60 seconds. Good luck!
                </p>
                <button
                  type="button"
                  onClick={startGame}
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl bg-white p-6 shadow-xl">
                ...
                <div className="bg-gray-900 rounded-lg p-4 mb-4">
                  {codeLines.map(({ id, line, lineNumber }) => (
                    <button
                      type="button"
                      key={id}
                      ...
                      className={`w-full text-left font-mono text-sm py-1 px-2 hover:bg-gray-800 rounded transition-colors ${
                        selectedLine === lineNumber ? 'bg-blue-600 text-white' : 'text-gray-300'
                      }`}
                    >
