...
1. Decompose the remaining 238 of 266 planned RWD activity families into concept clusters, original step objectives, interactions, checks, hints, feedback, correction branches, delayed scheduling, and transfer evidence without treating planning floors as authored steps.
