...
1. Build one complete activity-level RWD evidence matrix on the repaired 38-module sequence; cover all 186 concepts through original introduce, model, guided, faded, debug, retrieve, assess, correction, delayed-retention, and transfer events.
