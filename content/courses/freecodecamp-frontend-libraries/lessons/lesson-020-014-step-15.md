...
1. You should use `btns.forEach()` to iterate over the buttons.
2. All buttons should have event listeners that call `updateCount` when clicked.
...
*Original Challenge ID: 68a9fa18ad7a8432d0fc8621*
