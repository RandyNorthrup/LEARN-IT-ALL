...
3. const firstButton = columns?.[0]?.querySelectorAll(`:scope ${'button'}`)
assert.lengthOf(firstButton,1);
4. const secondButton = columns?.[1]?.querySelectorAll(`:scope ${'button'}`)
assert.lengthOf(secondButton,1);
5. const thirdButton = columns?.[2]?.querySelectorAll(`:scope ${'button'}`)
assert.lengthOf(thirdButton,1);
6. Each of your `button` elements should have a closing tag.
7. Each of your `div` elements should have a closing tag.
...
*Original Challenge ID: bad88fee1348ce8acef08815*
