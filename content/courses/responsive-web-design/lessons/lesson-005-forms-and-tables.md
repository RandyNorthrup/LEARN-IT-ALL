---
id: lesson-005-forms-and-tables
title: "Collect and Present Structured Data"
chapterId: ch2-semantic-data
order: 5
duration: 35
objectives:
  - "Build usable forms and data tables with explicit relationships."
---

# Collect and Present Structured Data

## Why this matters

Responsive interfaces work when structure, presentation, and interaction reinforce one another. Build usable forms and data tables with explicit relationships. This lesson gives you a mental model first, then asks you to prove it in a real build.
...
**WORKSHOP:** Create a workshop signup form beside a compact schedule table.
