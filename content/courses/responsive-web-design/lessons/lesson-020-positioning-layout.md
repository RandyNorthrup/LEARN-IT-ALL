---
id: lesson-020-positioning-layout
...
# Normal Flow, Positioning, and Stacking

## Why this matters

Responsive interfaces work when structure, presentation, and interaction reinforce one another. Use flow, floats, positioned offsets, containing blocks, and stacking contexts predictably. This lesson gives you a mental model first, then asks you to prove it in a real build.
...
**WORKSHOP:** Create a sticky table-of-contents and anchored notification badge.
