---
id: lesson-004-semantic-landmarks
title: "Shape Meaning with Semantic HTML"
chapterId: ch2-semantic-data
order: 4
duration: 35
objectives:
  - "Select landmarks and content elements based on meaning, not appearance."
---

# Shape Meaning with Semantic HTML

## Why this matters

Responsive interfaces work when structure, presentation, and interaction reinforce one another. Select landmarks and content elements based on meaning, not appearance. This lesson gives you a mental model first, then asks you to prove it in a real build.
...
**WORKSHOP:** Build a blog article whose landmarks and time metadata remain useful without CSS.
