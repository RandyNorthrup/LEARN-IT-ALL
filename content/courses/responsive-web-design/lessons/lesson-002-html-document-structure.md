---
id: lesson-002-html-document-structure
title: "Build a Valid HTML Document"
chapterId: ch1-web-foundations
order: 2
duration: 35
objectives:
  - "Use HTML boilerplate, metadata, headings, paragraphs, lists, and links correctly."
---
...
Responsive interfaces work when structure, presentation, and interaction reinforce one another. Use HTML boilerplate, metadata, headings, paragraphs, lists, and links correctly. This lesson gives you a mental model first, then asks you to prove it in a real build.
...
**WORKSHOP:** Create a complete learning roadmap document with metadata and a short ordered list.
