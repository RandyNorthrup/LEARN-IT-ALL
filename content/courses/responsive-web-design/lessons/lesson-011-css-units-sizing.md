---
id: lesson-011-css-units-sizing
title: "Size Interfaces with Intent"
chapterId: ch4-css-foundations
order: 11
duration: 35
objectives:
  - "Choose absolute, font-relative, viewport, container, and percentage units safely."
---

# Size Interfaces with Intent

## Why this matters

Responsive interfaces work when structure, presentation, and interaction reinforce one another. Choose absolute, font-relative, viewport, container, and percentage units safely. This lesson gives you a mental model first, then asks you to prove it in a real build.
...
**LAB:** Create a fluid hero whose type and spacing adapt without breakpoint jumps.
