...
1. Your code should use the `axisLeft()` method with `yScale` passed as the argument.
2. The y-axis `g` element should have a `transform` attribute to translate the axis by `(60, 0)`.
3. Your code should call the `yAxis`.
...
*Original Challenge ID: 587d7fad367417b2b2512bdf*
