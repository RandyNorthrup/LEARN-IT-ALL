...
1. Your code should store the data in the `html` variable
2. Your code should use a `forEach` method to loop over the JSON data from the API.
3. Your code should wrap the key names in `strong` tags.
...
*Original Challenge ID: 587d7fae367417b2b2512be5*
