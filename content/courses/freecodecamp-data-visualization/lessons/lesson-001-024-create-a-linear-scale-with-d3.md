...
1. The text in the `h2` should be `50`.
2. Your code should use the `scaleLinear()` method.
3. The `output` variable should call `scale` with an argument of `50`.
...
*Original Challenge ID: 587d7fab367417b2b2512bda*
