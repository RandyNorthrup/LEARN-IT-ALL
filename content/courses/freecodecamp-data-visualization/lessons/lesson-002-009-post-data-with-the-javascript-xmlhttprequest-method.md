...
2. Your code should use the `open` method to initialize a `POST` request to the server.
3. Your code should use the `setRequestHeader` method.
4. Your code should have an `onreadystatechange` event handler set to a function.
5. Your code should get the element with class `message` and change its `textContent` to `userName loves cats`
6. Your code should use the `send` method.
...
*Original Challenge ID: 587d7faf367417b2b2512be9*
