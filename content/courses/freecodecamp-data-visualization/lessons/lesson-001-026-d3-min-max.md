---
id: lesson-001-026
title: "Use the d3.max and d3.min Functions to Find Data Extremes"
...
1. The text in the `h2` should be `8`.
2. Your code should use the `max()` method.
...
*Original Challenge ID: 587d7fac367417b2b2512bdc*
