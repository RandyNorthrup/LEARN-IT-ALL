...
1. Your document should have 1 `svg` element.
2. The `svg` element should have a `width` attribute set to `500` or styled to have a width of `500px`.
3. The `svg` element should have a `height` attribute set to `100` or styled to have a height of `100px`.
...
*Original Challenge ID: 587d7fa8367417b2b2512bcb*
