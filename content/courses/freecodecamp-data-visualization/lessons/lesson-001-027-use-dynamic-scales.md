...
1. The text in the `h2` should be `30`.
2. The `domain()` of yScale should be equivalent to `[0, 411]`.
3. The `range()` of yScale should be equivalent to `[470, 30]`.
...
*Original Challenge ID: 587d7fac367417b2b2512bdd*
