...
1. Your code should create a new `XMLHttpRequest`.
2. Your code should use the `open` method to initialize a `GET` request to the freeCodeCamp Cat Photo API.
3. Your code should use the `send` method to send the request.
4. Your code should have an `onload` event handler set to a function.
5. Your code should use the `JSON.parse` method to parse the `responseText`.
6. Your code should get the element with class `message` and change its inner HTML to the string of JSON data.
...
*Original Challenge ID: 587d7fae367417b2b2512be3*
