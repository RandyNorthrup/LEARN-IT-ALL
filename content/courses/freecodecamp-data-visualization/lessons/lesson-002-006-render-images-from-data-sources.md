...
1. You should use the `imageLink` property to display the images.
2. You should use the `altText` for the `alt` attribute values of the images.
...
*Original Challenge ID: 587d7fae367417b2b2512be6*
