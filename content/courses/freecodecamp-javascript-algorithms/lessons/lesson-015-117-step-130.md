...
1. You should use compound assignment to modify `gold`.
2. You should use `Math.floor()` to round the result of the monster's level times `6.7`.
3. You should add the result of `Math.floor(monsters[fighting].level * 6.7)` to `gold`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/)*
*Original Challenge ID: 62a8eefe2e68b66ac563816b*
