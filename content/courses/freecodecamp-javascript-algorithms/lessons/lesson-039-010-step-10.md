...
2. When your `keepScoreBtn` is clicked, the radio options should be reset.
3. When your `keepScoreBtn` is clicked, the score history should be updated.
4. When your `keepScoreBtn` is clicked, and no options are selected, you should display an alert to the user.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/)*
*Original Challenge ID: 657d4a7e2002f822c646204b*
