...
2. You should not use `let` or `const` to access the `innerText` property of `text`.
3. You should update the `innerText` property of `text` to be `"You enter the store."`.
4. You should update the `innerText` property within your `goStore` function.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/)*
*Original Challenge ID: 62a7bfabe119461eb13ccbd6*
