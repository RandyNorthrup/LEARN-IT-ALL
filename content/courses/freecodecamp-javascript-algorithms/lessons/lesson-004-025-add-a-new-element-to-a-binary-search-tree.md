...
2. The binary search tree should have a method called `add`.
3. The add method should add elements according to the binary search tree rules.
4. Adding an element that already exists should return `null`.
...
*Original Challenge ID: 587d8257367417b2b2512c7b*
