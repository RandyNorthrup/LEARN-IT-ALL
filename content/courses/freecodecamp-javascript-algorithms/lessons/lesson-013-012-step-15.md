...
1. You should call `updateUI()` in your `sortInputArray()` function.
2. You should pass `inputValues` as an argument to `updateUI()`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/)*
*Original Challenge ID: 6407c6d3f19c4e0a7ba320bb*
