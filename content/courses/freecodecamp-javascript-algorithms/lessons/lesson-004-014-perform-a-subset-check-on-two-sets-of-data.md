...
1. Your `Set` class should have a `isSubsetOf` method.
2. The first `Set` should be contained in the second `Set`.
3. `['a', 'b'].isSubsetOf(['a', 'b', 'c', 'd'])` should return `true`.
4. `['a', 'b', 'c'].isSubsetOf(['a', 'b'])` should return `false`.
5. `[].isSubsetOf([])` should return `true`.
6. `['a', 'b'].isSubsetOf(['c', 'd'])` should return `false`.
...
*Original Challenge ID: 587d8254367417b2b2512c6f*
