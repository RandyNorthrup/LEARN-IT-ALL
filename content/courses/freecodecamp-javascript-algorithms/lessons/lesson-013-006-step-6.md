...
1. You should use the spread operator on `document.getElementsByClassName()`.
2. You should wrap the spread operator and `.getElementsByClassName()` in square brackets to create an array.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/)*
*Original Challenge ID: 6406bb32f9ed593f26c33b2b*
