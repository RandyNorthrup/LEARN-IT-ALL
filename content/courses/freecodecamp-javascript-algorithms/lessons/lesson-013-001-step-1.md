...
1. You should declare a `sortButton` variable with `const`.
2. You should call `document.getElementById()` with the argument `"sort"`.
3. You should assign the value of `document.getElementById()` to `sortButton`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/)*
*Original Challenge ID: 64061a98f704a014b44afdb2*
