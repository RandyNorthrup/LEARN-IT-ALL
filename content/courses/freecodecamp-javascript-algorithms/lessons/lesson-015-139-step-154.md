...
1. You should add an `if` statement to your `attack` function.
2. Your new `if` statement should check `Math.random() <= .1`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/)*
*Original Challenge ID: 62aa21ea8d9d9f396b95dd87*
