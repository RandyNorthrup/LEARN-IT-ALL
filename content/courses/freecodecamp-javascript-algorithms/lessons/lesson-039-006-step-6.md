...
1. `updateRadioOption` should be a function.
2. `updateRadioOption` should update the `scoreInputs` element at the provided index to be enabled.
3. `updateRadioOption` should update the value of the `scoreInputs` element at the provided index to be the given score.
4. `updateRadioOption` should update the text of the `scoreSpans` element at the provided index to be the text `", score = "` followed by the given score.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/)*
*Original Challenge ID: 657caf204c0d672a35411c31*
