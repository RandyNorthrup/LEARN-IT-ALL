...
1. You should update your fifth `locations` object to have a `"button functions"` property of `[goTown, goTown, easterEgg]`.
...
*Original Challenge ID: 62aa2ba9cd881355a6f0a5a8*
