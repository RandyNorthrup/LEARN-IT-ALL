...
1. You should use the `return` keyword to return the value of `hit`.
2. Your function should return the expected value.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/)*
*Original Challenge ID: 62aa1e8ccd579330e097ce44*
