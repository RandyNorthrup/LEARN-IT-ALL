...
1. You should call the `Number()` function in your `.map()` callback.
2. You should pass `dropdown.value` to your `Number()` call.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/)*
*Original Challenge ID: 6621d0dd6798b121bd2ed823*
