...
1. Your `buffer` should be 64 bytes large.
2. Your `i32View` view of your buffer should be 64 bytes large.
3. Your `i32View` view of your buffer should be 16 elements long.
...
*Original Challenge ID: 587d8253367417b2b2512c6a*
