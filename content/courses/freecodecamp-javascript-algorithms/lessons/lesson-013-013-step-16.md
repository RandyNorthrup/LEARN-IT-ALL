...
1. You should use `const` to declare a `bubbleSort` variable.
2. `bubbleSort` should be a function.
3. `bubbleSort` should use arrow syntax.
4. `bubbleSort` should take a single `array` parameter.
5. `bubbleSort` should be empty.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/)*
*Original Challenge ID: 6407c722498bc80b76d29073*
