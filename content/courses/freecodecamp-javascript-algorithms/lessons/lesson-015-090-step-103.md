...
1. Your `sellWeapon` function should have an `if` statement.
2. Your `if` statement should check if `inventory.length` is greater than `1`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/)*
*Original Challenge ID: 62a8d31ebbc10e3fe1b28e03*
