...
1. You should use `const` to declare an `updateUI` variable.
2. `updateUI` should be a function.
3. `updateUI` should use arrow syntax.
4. `updateUI` should take a single `array` parameter.
5. `updateUI` should have a fallback value of an empty array for `array`.
6. `updateUI` should be empty.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/)*
*Original Challenge ID: 6407c303b4272606c019f338*
