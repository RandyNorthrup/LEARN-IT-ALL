...
1. Your `Set` class should have a `union` method.
2. The union of a `Set` containing values `["a", "b", "c"]` and a `Set` containing values `["c", "d"]` should return a new `Set` containing values `["a", "b", "c", "d"]`.
...
*Original Challenge ID: 587d8253367417b2b2512c6c*
