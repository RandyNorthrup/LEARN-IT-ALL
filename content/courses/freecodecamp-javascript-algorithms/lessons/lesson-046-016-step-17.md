...
1. You should have an `if` statement that checks if `distance` is not equal to `INF` and if the neighbor node has not been visited.
2. You should create a variable named `new_distance` inside the `if` block.
3. You should assign `new_distance` the sum of `distances[current]` and `distance`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/)*
*Original Challenge ID: 68777816e95d4936f129819f*
