...
1. You should chain the `map` method directly on your array.
2. Your `map` callback function should use arrow function syntax.
3. Your `map` callback function should take a `dropdown` parameter.
4. Your `map` callback function should implicitly return `dropdown.value`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/)*
*Original Challenge ID: 6407b940b8983005578d0824*
