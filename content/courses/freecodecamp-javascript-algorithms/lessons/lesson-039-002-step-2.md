...
1. Your `rulesContainer` should not be visible initially.
2. When your `rulesBtn` is clicked, your `isModalShowing` should be `true`.
...
5. When your `rulesBtn` is clicked twice, your `isModalShowing` should be `false`.
...
*Original Challenge ID: 657a19e477dc04e36a86dffc*
