...
1. Your `LinkedList` class should have a `add` method.
2. Your `LinkedList` class should assign `head` to the first node added.
3. The previous `node` in your `LinkedList` class should have reference to the newest node created.
4. The  `size` of your `LinkedList` class should equal the amount of nodes in the linked list.
...
*Original Challenge ID: 587d8251367417b2b2512c62*
