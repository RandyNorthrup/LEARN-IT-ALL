...
1. You should not call the `changeBackgroundColor` function. Instead, assign the function reference to the `onclick` property.
...
*Original Challenge ID: 66326913b729e16dd0127a36*
