...
2. Your `else if` statement should check if `5` is less than `10`.
3. You should log the string `"5 is less than 10"` to the console.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/)*
*Original Challenge ID: 66458f0a05df478aa627629e*
