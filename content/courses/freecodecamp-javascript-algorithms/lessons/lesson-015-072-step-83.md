...
1. You should use compound assignment to subtract `30` from `gold`.
2. Your `buyWeapon` function should reduce `gold` by `30`.
3. Your code should be in your `if` statement.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/)*
*Original Challenge ID: 62a8c89e4272512d44fc1c66*
