...
1. You should update the `value` of the `option` element that is `selected` to `1`.
2. You should update the text of the `option` element that is `selected` to `1`.
...
*Original Challenge ID: 64113249bab9952fb2ce4469*
