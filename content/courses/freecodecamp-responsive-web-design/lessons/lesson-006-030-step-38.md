...
1. You should set the `width` property to `50%` in your `.flavor` selector.
2. You should set the `width` property to `50%` in your `.price` selector.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 5f3c866d0fc037f7311b4ac8*
