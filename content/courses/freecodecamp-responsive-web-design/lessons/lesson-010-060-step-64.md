...
1. You should have a `.quote::before` selector.
2. Your `.quote::before` selector should have a `content` property set to `'" '`.
3. You should have a `.quote::after` selector.
4. Your `.quote::after` selector should have a `content` property set to `' "'`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148d3fff5186b57123d97e2*
