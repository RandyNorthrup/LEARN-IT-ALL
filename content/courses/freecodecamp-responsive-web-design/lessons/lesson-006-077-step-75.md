...
1. You should add a `.bottom-line` selector.
2. You should set the `margin-top` property to `25px`.
3. Your `.bottom-line` selector should have a `margin-top` of `25px`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 5f46fc57528aa1c4b5ea7c2e*
