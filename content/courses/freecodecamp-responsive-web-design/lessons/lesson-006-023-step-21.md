...
1. You should have a `#menu` selector.
2. You should set the `width` property to `300px`.
3. Your `div` should have a width of 300px.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 5f356ed63c7807a4f1e6d054*
