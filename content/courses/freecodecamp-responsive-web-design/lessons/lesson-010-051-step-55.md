...
1. Your `.text` selector should have a `font-size` property set to `1.8rem`.
2. Your `.text` selector should have a `letter-spacing` property set to `0.6px`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148c6aa9981d74af202125e*
