...
1. You should create an `h3` element within your `article` element.
2. You should create a `p` element within your `article` element.
3. You should create a `ul` element within your `article` element.
4. Your elements within the `article` element should be in the correct order.
5. Your new `h3` element should have the `class` set to `list-title`.
6. Your new `h3` element should have the text of `A Brief History`.
7. Your new `p` element should have the text of `Of the Curriculum`.
8. Your new `ul` element should have the `class` set to `lists`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6143b97c06c3306d23d5da47*
