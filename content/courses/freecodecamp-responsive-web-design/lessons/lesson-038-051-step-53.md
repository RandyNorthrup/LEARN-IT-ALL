...
1. You should use the `.info` selector.
2. You should give `.info` a `padding-top` of at least `1px`.
3. You should give `.info` a `padding-right` of `0`.
4. You should give `.info` a `padding-bottom` of `0`.
5. You should give `.info` a `padding-left` of at least `1px`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 614883b6fa720e09fb167de9*
