...
1. You should add either a `button` or `input` element.
2. You should place the submit button within the `form` element.
3. You should place the submit button after the last `section` element.
4. You should give the submit button a `type` of `submit`.
5. The submit button should display the text `Send`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6145f685797bd30df9784e8c*
