...
1. You should add a sixth `p` element to the `.text` element.
2. Your sixth `p` element should have the provided text.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6143a778bffc206ac6b1dbe3*
