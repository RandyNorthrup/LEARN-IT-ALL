...
1. You should set the `margin-top` property to `-25px`.
2. Your `img` elements should have a `margin-top` value of `-25px`.
...
*Original Challenge ID: 5f47fe7e31980053a8d4403b*
