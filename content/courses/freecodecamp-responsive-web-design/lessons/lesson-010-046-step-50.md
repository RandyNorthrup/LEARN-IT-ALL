...
1. You should have a `.social-icons` selector.
2. Your `.social-icons` selector should have a `display` property set to `grid`.
3. Your `.social-icons` selector should have a `font-size` property set to `3rem`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148c004ffc8434252940dc3*
