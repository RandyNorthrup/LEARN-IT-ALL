...
1. You should create three `img` elements within your `aside` element.
2. You should create a `blockquote` element within your `aside` element.
3. Your `blockquote` element should have a `class` set to `image-quote`.
4. Your new elements should be in the correct order.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6143bb50e8e48c6f5ef9d8d5*
