...
1. You should use an attribute selector to style the `input` element.
2. You should give the `input[type="file"]` a `padding` of `1px 2px`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 60ffec2825da1007509ddd06*
