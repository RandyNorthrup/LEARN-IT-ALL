...
1. You should not change the `width` property. Use the `min-width` property.
2. You should use the existing `margin` property to include `1em` on the top and bottom.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 60ffe9cb47809106eda2f2c9*
