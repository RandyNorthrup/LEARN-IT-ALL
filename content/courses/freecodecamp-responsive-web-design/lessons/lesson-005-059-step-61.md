...
1. You should use the `.answers-list` selector.
2. You should give `.answers-list` a `list-style` of `none`.
3. You should give `.answers-list` a `padding` of `0`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148defa9c01520fb9d178a0*
