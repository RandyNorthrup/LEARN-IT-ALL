...
1. You should have a `.publish-date` selector.
2. Your `.publish-date` selector should have a `color` property set to `rgba(255, 255, 255, 0.5)`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148bfc43df3bc40fe0e6405*
