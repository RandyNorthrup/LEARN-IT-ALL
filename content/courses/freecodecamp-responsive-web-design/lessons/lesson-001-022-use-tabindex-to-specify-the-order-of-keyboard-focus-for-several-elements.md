...
1. Your code should add a `tabindex` attribute to the `search` `input` tag.
2. Your code should add a `tabindex` attribute to the `submit` `input` tag.
3. Your code should set the `tabindex` attribute on the `search` `input` tag to a value of 1.
4. Your code should set the `tabindex` attribute on the `submit` `input` tag to a value of 2.
...
*Original Challenge ID: 587d7790367417b2b2512ab1*
