...
1. Your `.text-with-images` selector should have a `grid-template-columns` property set to `1fr 2fr`.
2. Your `.text-with-images` selector should have a `column-gap` property set to `3rem`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148d7720f0db36775db868a*
