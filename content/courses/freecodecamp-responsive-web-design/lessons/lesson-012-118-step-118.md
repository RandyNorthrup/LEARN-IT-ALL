...
1. You should add `--window-color1` with a value of `#777`.
2. You should add `--window-color2` with a value of `#777`.
3. You should add `--window-color3` with a value of `#777`.
4. You should add `--window-color4` with a value of `#777`.
...
*Original Challenge ID: 5d822fd413a79914d39e993e*
