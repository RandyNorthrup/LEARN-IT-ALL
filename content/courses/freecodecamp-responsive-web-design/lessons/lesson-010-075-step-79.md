...
1. You should have a new `@media` query for `only screen` with a `max-width` of `550px`. This should come after your previous two.
2. Your new `@media` rule should have a `.hero-title` selector, a `.hero-subtitle, .author, .quote, .list-title` selector, a `.social-icons` selector, and a `.text` selector. These selectors should be in this order.
3. Your `.hero-title` selector should have a `font-size` set to `6rem`.
4. Your `.hero-subtitle, .author, .quote, .list-title` selector should have a `font-size` set to `1.8rem`.
5. Your `.social-icons` selector should have a `font-size` set to `2rem`.
6. Your `.text` selector should have a `font-size` set to `1.6rem`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148f693e0728f77c87f3020*
