...
1. You should have one `@media (prefers-reduced-motion: no-preference)` rule.
2. You should wrap the existing `*` rule within the `@media` rule.
...
*Original Challenge ID: 6148e41c728f65138addf9cc*
