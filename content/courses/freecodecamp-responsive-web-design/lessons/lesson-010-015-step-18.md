...
2. Your new `section` element should come after your `.text` element.
3. Your new `section` element should have the `class` set to `text text-with-images`.
4. Your new `section` element should have an `article` element.
5. Your new `section` element should have an `aside` element.
6. The `article` element should come before the `aside` element.
7. Your `article` element should have the `class` set to `brief-history`.
8. Your `aside` element should have the `class` set to `image-wrapper`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6143a83fcc32c26bcfae3efa*
