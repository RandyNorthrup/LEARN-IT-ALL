...
1. You should add two `div` elements within `.fb4`.
2. You should give the first new `div` a class of `fb4a`.
3. You should give the second new `div` a class of `fb4b`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 5d822fd413a79914d39e9929*
