...
1. You should have an `.author` selector.
2. Your `.author` selector should have a `font-size` property set to `2rem`.
3. Your `.author` selector should have a `font-family` property set to `Raleway` with a fallback of `sans-serif`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148be82ca63c63daa8cca49*
