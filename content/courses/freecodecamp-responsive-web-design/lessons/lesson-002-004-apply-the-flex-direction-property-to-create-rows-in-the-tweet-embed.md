...
2. The `header` should have a `flex-direction` property set to `row`.
3. The `footer` should have a `flex-direction` property set to `row`.
...
*Original Challenge ID: 587d78ab367417b2b2512af3*
