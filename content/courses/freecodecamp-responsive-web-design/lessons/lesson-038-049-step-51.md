...
1. You should use a `section` selector.
2. You should give the `section` a `width` of `80%`.
3. You should give the `section` a `margin-top` of `0`.
4. You should give the `section` a `margin-right` of `auto`.
5. You should give the `section` a `margin-bottom` of `10px`.
6. You should give the `section` a `margin-left` of `auto`.
7. You should give the `section` a `max-width` of `600px`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 61487f703571b60899055cf9*
