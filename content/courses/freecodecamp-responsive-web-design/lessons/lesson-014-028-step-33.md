...
1. You should add a `label` to the third `fieldset`, after the existing `label`.
2. You should give the `label` the text `Input your age (years): `.
3. You should give the `label` an `input` with `type` of `number`.
4. You should give the `input` a `min` attribute with a value of `13`.
5. You should give the `input` a `max` attribute with a value of `120`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 60fabf0dd4959805dbae09e6*
