...
1. You should add a fourth `p` element to your `.text` element.
2. Your new `p` element should come after your `blockquote` element.
3. Your new `p` element should have the provided text.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6143a1a228f7d068ab16a130*
