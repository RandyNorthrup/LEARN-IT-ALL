...
1. You should have a new `@media` rule for `only screen and (max-width: 720px)`.
2. Your new `@media` rule should have an `.image-wrapper` selector.
3. Your new `.image-wrapper` selector should have a `grid-template-columns` property of `1fr`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148f34ebedc2274bceeb99c*
