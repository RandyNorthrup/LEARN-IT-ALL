...
1. You should use either the `.info input` or `.info > input` selector.
2. You should give the `input` elements a `width` of `50%`.
3. You should give the `input` elements a `text-align` of `left`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 61488ecfd05e290b5712e6da*
