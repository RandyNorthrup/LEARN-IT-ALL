...
1. Your third `img` element should have a `src` set to `https://cdn.freecodecamp.org/testable-projects-fcc/images/survey-form-background.jpeg`.
2. Your third `img` element should have an `alt` set to `four people working on code`.
3. Your third `img` element should have a `loading` attribute set to `lazy`.
4. Your third `img` element should have a `class` set to `image-3`.
5. Your third `img` element should have a `width` attribute set to `600`.
6. Your third `img` element should have a `height` attribute set to `400`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6143cdf48b634a747de42104*
