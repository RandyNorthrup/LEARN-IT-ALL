...
2. Your `body` selector should have a `font-family` property set to `Baskervville`, with a fallback of `serif`.
3. Your `body` selector should have a `color` property set to `linen`.
4. Your `body` selector should have a `background-color` property set to `rgb(20, 30, 40)`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6144d7dbdd3e580da730ff45*
