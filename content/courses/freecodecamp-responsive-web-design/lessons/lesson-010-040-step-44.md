...
1. You should have an `img` selector.
2. Your `img` selector should have a `width` property set to `100%`.
3. Your `img` selector should have an `object-fit` property set to `cover`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148b59ef318e03875f35c4a*
