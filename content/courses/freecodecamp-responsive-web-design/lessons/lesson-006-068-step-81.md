...
1. You should use the `a:hover` pseudoselector.
2. You should set the `color` property to `brown`.
3. Your `a:hover` should have a `color` of `brown`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 5f45b3c93c027860d9298dbd*
