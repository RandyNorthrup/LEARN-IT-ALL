...
1. You should add two `hr` elements to your `.image-quote` element.
2. You should add a `p` element to your `.image-quote` element.
3. Your `.image-quote` children should be in the correct order.
4. Your new `p` element should have a `class` set to `quote`.
5. Your new `p` element should have the text `The millions of people who are learning to code through freeCodeCamp will have an even better resource to help them learn these fundamentals.`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6143d003ad9e9d76766293ec*
