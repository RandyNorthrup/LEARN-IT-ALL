...
1. You should have a `.hero-title` selector.
2. Your `.hero-title` selector should have a `text-align` property set to `center`.
3. Your `.hero-title` selector should have a `color` property set to `orangered`.
4. Your `.hero-title` selector should have a `font-size` property set to `8rem`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148bd62bbb8c83a5f1fc1b3*
