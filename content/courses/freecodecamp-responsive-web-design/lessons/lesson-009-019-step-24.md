...
1. All nine of your `img` elements should have a `alt` attribute with text describing each image, with each description using at least `5` letters.
...
*Original Challenge ID: 6153a3ebb4f7f05b8401b716*
