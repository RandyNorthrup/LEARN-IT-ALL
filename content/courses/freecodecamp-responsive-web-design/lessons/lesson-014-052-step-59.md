...
1. You should give the submit button a `height` of `2em`.
2. You should give the submit button a `font-size` of `1.1rem`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 60ffe8a5ceb0e90618db06d9*
