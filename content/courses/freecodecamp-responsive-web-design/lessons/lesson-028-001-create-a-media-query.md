...
1. You should declare a `@media` query for devices with a `height` less than or equal to `800px`.
2. Your `p` element should have a `font-size` of `10px` when the device `height` is less than or equal to `800px`.
3. Your `p` element should have an initial `font-size` of `20px` when the device `height` is more than `800px`.
...
*Original Challenge ID: 587d78b0367417b2b2512b08*
