...
1. You should use the `footer` element selector.
2. You should give `footer` a `background-color` of `#2a2a40`.
3. You should give `footer` a `display` of `flex`.
4. You should give `footer` a `justify-content` of `center`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148e0bcc13efd10f7d7a6a9*
