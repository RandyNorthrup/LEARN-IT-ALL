...
1. You should use either the `.info label` or `.info > label` selector.
2. You should give the `label` elements a `width` of `10%`.
3. You should give the `label` elements a `min-width` of `55px`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148d99cdc7acd0c519862cb*
