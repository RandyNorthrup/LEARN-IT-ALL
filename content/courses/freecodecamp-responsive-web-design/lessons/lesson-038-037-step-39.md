...
1. You should nest one `textarea` element within the second `div.answer` element.
2. You should give the `textarea` a `rows` attribute with a number.
3. You should give the `textarea` a `cols` attribute with a number.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6145f47393fbe70c4d885f9c*
