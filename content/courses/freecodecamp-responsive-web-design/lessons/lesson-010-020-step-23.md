...
1. Your second `img` element should have a `src` set to `https://cdn.freecodecamp.org/testable-projects-fcc/images/calc.png`.
2. Your second `img` element should have an `alt` set to `image of a calculator project`.
3. Your second `img` element should have a `loading` attribute set to `lazy`.
4. Your second `img` element should have a `class` set to `image-2`.
5. Your second `img` element should have a `width` set to `400`.
6. Your second `img` element should have a `height` set to `400`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6143cd08fe927072ca3a371d*
