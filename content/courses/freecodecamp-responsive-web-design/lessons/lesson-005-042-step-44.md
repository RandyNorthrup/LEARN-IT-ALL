...
1. You should add an `a` element.
2. You should give the `a` element an `href` attribute of `https://freecodecamp.org`.
3. You should wrap the `a` element around the existing text `freeCodeCamp`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6145fb5018cb5b100cb2a88c*
