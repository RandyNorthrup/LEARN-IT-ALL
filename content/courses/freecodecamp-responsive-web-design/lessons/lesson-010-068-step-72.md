...
1. You should have an `.image-wrapper` selector.
2. Your `.image-wrapper` selector should have a `display` property set to `grid`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148e2dcdd60306dd77d41cc*
