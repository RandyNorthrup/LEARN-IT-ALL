...
1. You should give the `header` a `justify-content` of `space-between`.
2. You should give the `header` an `align-items` of `center`.
3. You should give the `header` a `top` of `0`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 614878f7a412310647873015*
