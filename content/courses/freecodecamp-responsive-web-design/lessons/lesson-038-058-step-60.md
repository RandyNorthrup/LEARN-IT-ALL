...
1. You should use the `.question` selector.
2. You should give the `.question` a `border` of `none`.
3. You should give the `.question` a `padding-bottom` of `0`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148dd31d210990f0fb140f8*
