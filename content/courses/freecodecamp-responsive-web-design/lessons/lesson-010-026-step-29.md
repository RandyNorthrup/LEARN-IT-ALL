...
1. You should have an `h1` selector.
2. Your `h1` selector should have a `font-family` property set to `Anton` with the fallback of `sans-serif`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6144de308591ec10e27d5383*
