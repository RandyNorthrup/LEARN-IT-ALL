...
1. You should have an `.image-1, .image-3` selector.
2. Your `.image-1, .image-3` selector should have a `grid-column` property set to `1 / -1`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148e789329dc9736ce59b85*
