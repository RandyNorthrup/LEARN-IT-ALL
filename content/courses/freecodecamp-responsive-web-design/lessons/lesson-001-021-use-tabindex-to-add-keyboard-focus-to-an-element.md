...
1. Your code should add a `tabindex` attribute to the `p` tag that holds the form instructions.
2. Your code should set the `tabindex` attribute on the `p` tag to a value of 0.
...
*Original Challenge ID: 587d7790367417b2b2512ab0*
