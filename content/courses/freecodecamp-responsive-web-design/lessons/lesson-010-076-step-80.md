...
1. You should have a new `@media` query for `only screen and (max-width: 420px)`. This should be the last query in the `@media` query list.
2. Your new `@media` query should have a `.hero-title` selector.
3. Your `.hero-title` selector should have a `font-size` property set to `4.5rem`.
...
*Original Challenge ID: 6148f6f7d8914c78e93136ca*
