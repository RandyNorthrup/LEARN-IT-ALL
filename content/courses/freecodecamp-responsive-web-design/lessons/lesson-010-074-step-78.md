...
1. You should create a new `@media` query for `only screen and (max-width: 600px)`. This should be below your previous `@media` query.
2. Your new `@media` query should have a `.text-with-images` selector.
3. Your new `.text-with-images` selector should have a `grid-template-columns` property with a value of `1fr`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148f600cde42b7670c2611f*
