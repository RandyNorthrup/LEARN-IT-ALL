...
1. You should have a `.hero-subtitle` selector.
2. Your `.hero-subtitle` selector should have a `font-size` property set to `2.4rem`.
3. Your `.hero-subtitle` selector should have a `color` property set to `orangered`.
4. Your `.hero-subtitle` selector should have a `text-align` property set to `center`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148be3d605d6b3ca9425d11*
