...
1. You should use the `h3` element selector.
2. You should give the `h3` element a `margin-top` of `5px`.
3. You should give the `h3` element a `padding-left` of `15px`.
4. You should give the `h3` element a `font-size` of `1.375ren`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148dcaaf2e8750e6cb4501a*
