...
1. You should add an `.address` selector.
2. You should set the `margin-bottom` property to `5px`.
3. Your `.address` selector should have the `margin-bottom` property set to `5px`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 5f46e36e745ead58487aabf2*
