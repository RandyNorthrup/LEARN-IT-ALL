...
1. You should add one `footer` element after the `main` element.
2. You should nest one `address` element within the `footer` element.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6145f829ac6a920ebf5797d7*
