...
1. You should use either the `nav li` or `nav > ul > li` selector.
2. You should give the `li` elements a `color` of `#dfdfe2`.
3. You should give the `li` elements a `margin` of `0 0.2rem`.
4. You should give the `li` elements a `padding` of `0.2rem`.
5. You should give the `li` elements a `display` of `block`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6145fc3707fc3310c277f5c8*
