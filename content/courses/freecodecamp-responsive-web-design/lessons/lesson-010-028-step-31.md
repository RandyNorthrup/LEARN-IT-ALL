...
1. You should have an `a` selector.
2. Your `a` selector should have a `text-decoration` property set to `none`.
3. Your `a` selector should have a `color` property set to `linen`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6144ee46a9d6e614c598cc05*
