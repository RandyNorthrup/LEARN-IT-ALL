...
1. You should use either a `.info > label, .info > input` or `.info label, .info input` selector.
2. You should give the `input` and `label` elements a `display` of `inline-block`.
3. You should give the `label` element a `text-align` of `right`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148da157cc0bd0d06df5c0a*
