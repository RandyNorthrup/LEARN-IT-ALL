...
2. Your `*, ::before, ::after` selector should have a `padding` property set to `0`.
3. Your `*, ::before, ::after` selector should have a `margin` property set to `0`.
4. Your `*, ::before, ::after` selector should have a `box-sizing` property set to `border-box`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6143d2842b497779bad947de*
