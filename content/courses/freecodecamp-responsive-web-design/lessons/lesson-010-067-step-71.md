...
1. You should have a `.list-title, .list-subtitle` selector.
2. Your `.list-title, .list-subtitle` selector should have a `color` property set to `#00beef`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148e246146b646cf4255f0c*
