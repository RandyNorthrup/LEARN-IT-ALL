...
1. You should have a `.heading` selector.
2. Your `.heading` selector should have a `grid-column` property set to `2 / 3`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6144f47b7c631e1a6f304dd5*
