...
1. You should create a `.window-wrap` selector.
2. You should give `.window-wrap` a `display` of `flex`.
3. You should give `.window-wrap` an `align-items` of `center`.
4. You should give `.window-wrap` a `justify-content` of `space-evenly`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 5d822fd413a79914d39e990f*
