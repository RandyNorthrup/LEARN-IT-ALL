...
1. You should have a `.quote` selector.
2. Your `.quote` selector should have a `color` property set to `#00beef`.
3. Your `.quote` selector should have a `font-size` property set to `2.4rem`.
4. Your `.quote` selector should have a `text-align` property set to `center`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148d2444d01ab541e64a1e4*
