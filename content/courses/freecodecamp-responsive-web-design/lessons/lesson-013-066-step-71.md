...
2. You should give the `meta` element a `charset` of `UTF-8`.
3. Your `meta` element should be a void element, you don't need to add `</meta>`.
...
*Original Challenge ID: 62bb4009e3458a128ff57d5d*
