...
1. You should have a `.text-with-images` selector.
2. Your `.text-with-images` selector should have a `display` property set to `grid`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148d4d57b965358c9fa38bf*
