...
1. You should have a `.lists li` selector.
2. Your `.lists li` selector should have a `margin-bottom` property set to `1.5rem`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148e19c3e26436be0155690*
