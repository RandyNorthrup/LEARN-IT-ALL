...
1. Your first `img` element should have a `src` attribute set to `https://cdn.freecodecamp.org/testable-projects-fcc/images/random-quote-machine.png`.
2. Your first `img` element should have an `alt` attribute set to `image of the quote machine project`.
3. Your first `img` element should have a `class` attribute set to `image-1`.
4. Your first `img` element should have a `loading` attribute set to `lazy`.
5. Your first `img` element should have a `width` attribute set to `600`.
6. Your first `img` element should have a `height` attribute set to `400`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6143c2a363865c715f1a3f72*
