...
1. Your `.image-wrapper` selector should have a `grid-template-columns` property set to `2fr 1fr`.
2. Your `.image-wrapper` selector should have a `grid-template-rows` property set to `repeat(3, min-content)`.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 6148e4d6861a486f60681f36*
