...
1. You should give the `h1` a `text-align` of `center`.
2. You should add a `main` selector to target the `main` element.
3. You should give the `main` a `padding-top` of at least `25px`.
4. You should only change the `padding-top` value.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/responsive-web-design/)*
*Original Challenge ID: 61487b77d4a37707073a64e5*
