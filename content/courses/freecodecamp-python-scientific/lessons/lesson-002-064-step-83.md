...
1. You should declare a new function called `encrypt`. Remember to use the `pass` keyword inside the body.
2. Your `encrypt` function should take `message` and `key` as the parameters. The order matters.

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/scientific-computing-with-python/)*
*Original Challenge ID: 6555231eac4d9f19bd3d44b5*
