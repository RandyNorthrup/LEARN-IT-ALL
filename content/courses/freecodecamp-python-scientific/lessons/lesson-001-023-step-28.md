...
1. You should have `number = number // 10 + number % 10` within the `if` statement.
2. const someMatch = allowedMatches.some(allowedMatch => allowedMatch.test(block_body));
...
*Original Challenge ID: 65687db6a9fcf3c548a6c1b7*
