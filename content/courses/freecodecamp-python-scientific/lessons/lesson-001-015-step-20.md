...
1. You should have `sum_of_odd_digits += digit` within the `for` loop.
2. assert.match(function_body, /sum_of_odd_digits\s*\+=\s*digit/);

---

*Source: [freeCodeCamp](https://www.freecodecamp.org/learn/scientific-computing-with-python/)*
*Original Challenge ID: 65687b182c2a8fb1470e0b97*
