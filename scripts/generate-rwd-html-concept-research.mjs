...
const graph = {
  ...
  architectureFindings: [
    'The deleted generated sequence delayed first HTML construction behind thirteen tooling activities; files, browser, DevTools, and research must enter just in time around the first artifact.',
