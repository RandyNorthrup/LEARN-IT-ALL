...
const architecture = {
  ...
  gaps: [
    ...
    'Current blueprint and learner content remain migration input until the proposed opening vertical slice proves editor, feedback, persistence, assessment, tablet, and beginner-flow behavior.',
  ],
};
